...
| Matching `nestest` reference log | Never commit | Record source/revision/license and hash; compare under `compatibility/NESTEST_PROCEDURE.md` | Runner passes generated traces; external comparison not run |
