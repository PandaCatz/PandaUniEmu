...
| `perfect6502` transistor-level oracle | Not imported; pinned acquisition metadata only in `compatibility/PERFECT6502_PROVENANCE.md` | MIT-licensed `mist64/perfect6502`, commit `09fc542877a84318291aa42dab143a3e2c3db974`; archive SHA-256 `594553a873d66a13e88c134495c9f55e064a36ba4670b07fba71f5047a77bdf5` | Planned independent evidence for hardware IRQ/NMI/reset bus order, poll timing, and NMI hijacking; no compatibility claim currently relies on it |
